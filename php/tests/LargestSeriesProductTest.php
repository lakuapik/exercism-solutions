...
// https://github.com/exercism/php/blob/7483b522370e88962fd2605f1f6bd7a0f927b17c/exercises/practice/largest-series-product/LargestSeriesProductTest.php

namespace Tests;

use App\LargestSeriesProduct;
...
test('CanFindTheLargestProductOf2WithNumbersInOrder', function () {
...
test('CanGetTheLargestProductOfABigNumberProjectEuler', function () {
 ...
 *
 */
test('Reports1ForEmptyStringAndEmptyProduct0Span', function () {
 ...
 */
test('Reports1ForNonemptyStringAndEmptyProduct0Span', function () {
    $series = new LargestSeriesProduct('123');
    $this->assertEquals(1, $series->largestProduct(0));
})->skip();

test('RejectsEmptyStringAndNonzeroSpan', function () {
    $this->expectException(InvalidArgumentException::class);
...
test('RejectsInvalidCharacterInDigits', function () {
    $this->expectException(InvalidArgumentException::class);
...
test('RejectsNegativeSpan', function () {
    $this->expectException(InvalidArgumentException::class);
